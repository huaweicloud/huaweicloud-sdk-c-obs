...
#ifdef CONFIG_IDUMP
/* iDump: coredump_filter flags */
#define MMF_DUMP_TASK_STACK            2
#define MMF_DUMP_BIN_DATA              3
#define MMF_DUMP_BIN_EXEC              4
#define MMF_DUMP_LIB_DATA              5
#define MMF_DUMP_LIB_EXEC              6
#define MMF_DUMP_HEAP                  7
#define MMF_DUMP_MAPPED_DATAFILE       8
#define MMF_DUMP_HUGETLB               9
#define MMF_DUMP_ELF_HEADERS           10
#define MMF_DUMP_ANON                  11

#define MMF_DUMP_FILTER_SHIFT	MMF_DUMPABLE_BITS
#define MMF_DUMP_FILTER_BITS	10
#define MMF_DUMP_FILTER_MASK \
	(((1 << MMF_DUMP_FILTER_BITS) - 1) << MMF_DUMP_FILTER_SHIFT)
#define MMF_DUMP_FILTER_DEFAULT  ((0x3ff << MMF_DUMP_FILTER_SHIFT) & \
...
extern unsigned long KSTK_ESP_PROC(struct task_struct *task);
#endif
