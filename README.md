...
2. Enabled connection reuse to improve networking efficiency.
3. Upgraded dependency package versions.

**Bug Fixes:**

1. Resolved an issue with Chinese character encoding (mojibake) in the "List Objects" API under Linux environments.
