...
// get object metadata---------------------------------------------------------
static void test_get_object_metadata(int argc, char **argv, int optindex)
{
...
int main(int argc, char **argv)
{
    ...
    else if (!strcmp(command, "get_object_metadata"))
    {
        test_get_object_metadata(argc, argv, optind);
    }
