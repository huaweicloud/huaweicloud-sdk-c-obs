...
void delete_bucket_public_access_block(
    ...
    void *callback_data)
{
    ...
    COMMLOG(OBS_LOGINFO, "delete bucket public access block start!");
    ...
    COMMLOG(OBS_LOGINFO, "delete bucket public access block finish!");
}
