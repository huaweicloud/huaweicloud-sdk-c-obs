...
void delete_object_tagging(const obs_options *options, const char *key,
    obs_response_handler *handler, void *callback_data)
{
    request_params params;
    obs_use_api use_api = OBS_USE_API_S3;
    set_use_api_switch(options, &use_api);
    COMMLOG(OBS_LOGINFO, "delete object tagging start!");
    ...
    COMMLOG(OBS_LOGINFO, "delete object tagging finish!");
}