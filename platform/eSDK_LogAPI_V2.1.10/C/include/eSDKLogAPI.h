...
extern "C"
{
	...
	*@par 无
	**/
	eSDK_LOG_API void _STD_CALL_ Log_Run_Debug(const char* sdkname, const char* param, size_t paramLen);//运行类日志接口
	/**
	*运行类Info接口
	* 
	*该函数用于写run下的Info日志
	...
	*@par 无
	**/
	eSDK_LOG_API void _STD_CALL_ Log_Run_Info(const char* sdkname, const char* param, size_t paramLen);//运行类日志接口
	/**
	*运行类Warn接口
	* 
	*该函数用于写run下的Warn日志
	...
	*@par 无
	**/
	eSDK_LOG_API void _STD_CALL_ Log_Run_Warn(const char* sdkname, const char* param, size_t paramLen);//运行类日志接口
	/**
	*运行类Error接口
	* 
	*该函数用于写run下的Error日志
